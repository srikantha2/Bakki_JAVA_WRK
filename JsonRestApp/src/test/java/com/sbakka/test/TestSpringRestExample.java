...
import com.sbakka.model.Employee;
import com.sbakka.util.EmpRestURIConstants;


public class TestSpringRestExample {

	public static final String SERVER_URI = "http://localhost:8080/JsonRestApp";
	...
	private static void testCreateEmployee() {
		...
		emp.setId(1);emp.setName("Pankaj Kumar");emp.setCreatedDate(new Date());
